...
export default function ManagementData() {
    ...
    return (
        <PaperBlock>
            ...
            <div
                className={`grid p-5 gap-y-2 md:min-[920px]:grid-cols-5 sm:min-[500px]:grid-cols-1 place-items-center`}
            >
                <CardConfigMonitoria
                    title="Credores"
        ...
        `}
                ...
                >
                    <Ancora
                        ...
                        styles={`text-center cursor-pointer rounded-md py-2 px-2 text-md duration-300 text-white bg-transparent border border-emerald-500 hover:bg-emerald-500 hover:border-emerald-500 dark:bg-transparent dark:hover:bg-emerald-400
      `}
                    />
                </CardConfigMonitoria>
                ...
                >
                    <Ancora
                        ...
                        styles={`text-center cursor-pointer rounded-md py-2 px-2 text-md duration-300 text-white bg-transparent border border-amber-400 hover:bg-amber-600 hover:border-amber-600 dark:bg-transparent dark:hover:bg-amber-400
        `}
                    />
                </CardConfigMonitoria>
                ...
                >
                    <Ancora
                        ...
                        styles={`text-center cursor-pointer rounded-md py-2 px-2 text-md duration-300 text-white bg-transparent border border-rose-400 hover:bg-rose-600 hover:border-rose-600 dark:bg-transparent dark:hover:bg-rose-400
        `}
                    />
                </CardConfigMonitoria>
            </div>
