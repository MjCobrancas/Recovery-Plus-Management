        ...
        <>
            ...
            {questions.map((item, index) => {
                ...
                return (
                    <article
                        key={index}
                        className={`flex justify-between items-center p-2 mx-6 mb-1 rounded odd:bg-slate-200 even:bg-slate-300 dark:odd:bg-slate-500 dark:even:bg-slate-600`}
                    >
                        <div className={`flex items-center gap-2`}>
                            ...
                            {item.count > 0 && (
                                <span
                                    className={`bg-slate-50 px-1 text-gay-500 rounded dark:bg-slate-400`}
                                >
                                    Mais {item.count}
                                </span>
                            )}
                        ...
                        <div className={`flex gap-2`}>
                            <div>
                                <button
                                    ...
                                    className={`bg-blue-400 hover:bg-blue-500 hover:text-slate-200 duration-200 py-1 px-2 rounded disabled:bg-slate-300 disabled:border-slate-400 disabled:cursor-not-allowed disabled:text-gray-100 dark:disabled:bg-slate-500 dark:disabled:text-gray-200`}
